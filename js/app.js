...
async function login() {
    ...
    try {
        ...
        // Call SaaS backend API for authentication
        ...
        if (result.requires_organization_selection && result.organizations) {
...
async function completeLogin(result) {
    ...
    setTimeout(() => {
        ...
        if (dropdownName) dropdownName.textContent = user.first_name;
        ...
        if ((currentRole === 'owner' || currentRole === 'admin') && !user.is_super_admin) {
